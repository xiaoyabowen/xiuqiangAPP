...
var visitLogin = serverUrl + '/user/customer';//游客参观
//isTest = true;
//recommendServerUrl = "http://192.168.1.25:50050";

var userRegistUrl=serverUrl+"/user/request";//家长注册
var userLoginUrl=serverUrl+"/user/login";//家长登录
var createAuthCodeOnLoginUrl=serverUrl+"/user/createAuthCodeOnLogin";//根据手机号发送验证码
var createAuthCodeOnRegUrl=serverUrl+"/user/createAuthCodeOnReg";//根据手机号发送验证码
var updatePasswordAndLoginUrl=serverUrl+"/user/updatePasswordAndLogin";//更改密码并且登录

var getAllSchoolUrl=serverUrl+"/school/getAllSchoolByProvince ";//获取园所
var clazzPersonChildList = serverUrl+"/leave/clazzPersonChildList";// 参数：status 请假审批
...
//缴费相关的
var getUserNoPayChargeItemPagerUrl=serverUrl+"/charge/getUserNoPayChargeItemPager";//在线缴费
var getUserPayChargeItemPagerUrl=serverUrl+"/charge/getUserPayChargeItemPager";//2.	已缴费
var createAliChargeOrderUrl=serverUrl+"/order/createAliChargeOrder";//	3.缴费在线支付订单生成
var aliChargeOrderPayParamUrl=serverUrl+"/order/aliChargeOrderPayParam";//	4.	缴费在线支付参数请求
...
var getHotTags = serverUrl + "/tag/getHotTags";//获取常用标签
...
var userupdatePersonUser = serverUrl + "/user/updatePersonUser";//宝宝表现
var usergetInformations = serverUrl + "/user/getInformations";//获取宝宝表现
...
var DayCheckaddClazzCheck = serverUrl + "/dayCheck/addClazzCheck";//全班合格 cid day
var DayCheckgetaddSchoolCheck = serverUrl + "/dayCheck/addSchoolCheck";//全园合格 day

var usersearchUserParentsUrl = serverUrl + "/user/searchUserParents";//获取所有宝宝家长
var userdeleteUserUrl = serverUrl + "/user/deleteUser";//删除宝宝家长
var useraddUserUrl = serverUrl + "/user/addUser";//添加宝宝家长
...
//我
var getMyInformations = serverUrl +"/user/getInformations";//我的信息
var mainteacher = serverUrl +"/main/teacher";//我的主页
var updatebacked = serverUrl +"/user/updatePersonUser";//修改个人信息
var createAuthCodeOnReg = serverUrl +"/user/createAuthCodeOnReg";//获取验证码
var updateUserPhoneUrl = serverUrl+"/user/updatePhone";//修改手机号
...
var  CommentRemindStatus=serverUrl+"/user/updateRemind";//传 remindStatus   0开启，1关闭

var timelinedelete = serverUrl+"/timeline/delete";//删除动态，传tid


//新生预报名
var getSchool = serverUrl + '/school/getAllSchool'; //获取所有学校
var getAllSchoolByProvinceUrl = serverUrl + '/school/getAllSchoolByProvince'; //根据省市获取园所  获取所有学校   石和涛调试的  新修改的接口


var freshmanBooking = serverUrl + '/userRequest/add'; //预约报名 phone code parentName name sex birthDate
var createAliUserRequestOrder = serverUrl + '/order/createAliUserRequestOrder';//交占位费 sid urid
var aliUserRequestOrderPayParam = serverUrl + '/order/aliUserRequestOrderPayParam';//请求支付宝 oid

//教学资料
var pathGetUserAllList=serverUrl+"/path/getUserAllList";//家长：我的学习目录列表
...
var addMailboxUrl= serverUrl+"/mailbox/addMailbox";//园长信箱  添加
var getUserMailboxPagerUrl= serverUrl+"/mailbox/getUserMailboxPager";//园长信箱
...
/**
 *
 * @param url 跳转   内部跳转 inner://xxx/xxx?objectId=1&title=xxx 外部跳转 http://xxx/xxx?objectId=1  原生跳转：native://xxx?objectId=1
...
//  alert("打开用户的主页"+uid);
    var url = 'inner://login/login.html?uid=' + uid;

    systemForword(url,1,{reload:true});
}



//打开用户的照片list页面,打开用户的主页
function openUserHome1(uid){
//  alert("打开用户的主页"+uid);
    var url = 'native://chat?uid=1&title=1111';
    systemForword(url,-1,{reload:true});
}

//打开用户的照片list页面,打开用户的主页
function openUserHome2(uid){
//  alert("打开用户的主页"+uid);
    var url = 'http://www.baidu.com?uid=1&title=1111';
    systemForword(url,-1,{reload:true});
}
