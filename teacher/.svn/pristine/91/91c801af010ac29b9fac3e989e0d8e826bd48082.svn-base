...
// var serverUrl = "http://xiuqiang.ikid06.cn"; //线上
var serverUrl = "http://39.107.247.82:50001";
//isCleanUser = true;
var rootWindowName = "root";//cjn  root
simpleVersion = true;
...
var imgServer = 'http://store.quakoo.com/storage/guoguo/handle';


//分享地址
var shareNotice="http://http://39.107.247.82:99/html/classNotice_detail_body.html?nid=";

var getSchoolList = serverUrl + '/school/getAllSchoolByProvince';//根据所在地获取幼儿园名称
...
var dalCook = serverUrl + '/cookbook/delete';//删除食谱模板

// 固定资产
var appleAssets = serverUrl + '/fixedasset/reqItem'; //申请固定资产
var getAuditOk = serverUrl + '/fixedasset/getUserReqPassItemLogPager'; //获取审核通过
var getAuditWait = serverUrl + '/fixedasset/getUserReqItemLogPager';//获取待审核列表
var getAuditNo = serverUrl + '/fixedasset/getUserReqNoPassItemLogPager'; //获取审核未通过

var getAllTeachers = serverUrl + '/backend/getAllTeachers'; //获取申请人  参数：sid
var getAllLocations = serverUrl + '/fixedasset/getAllLocations'; //获取资产使用位置 参数：sid
var getUse = serverUrl + '/department/getAllList';//获取申请用途 参数：sid
var getAllListData = serverUrl + '/fixedasset/getReqItemSelects'; //获取申请列表数据  参数：sid

//仓库资源
var getWarehouseData = serverUrl + '/warehouse/getReqItemSelects'; //获取仓库所有集合数据
var getAllWarehouseName = serverUrl + '/warehouse/getAllWarehouses'; //获取所有仓库名称
var applyWarehouse = serverUrl + '/warehouse/reqItem'; //申请仓库资源
var getWarehouseWait = serverUrl + '/warehouse/getUserReqItemLogPager'; //获取申请中
var getWarehouseOk = serverUrl + '/warehouse/getUserReqPassItemLogPager'; //获取申请通过
var getWarehouseNo = serverUrl + '/warehouse/getUserReqNoPassItemLogPager'; //获取未通过
...
var deleteEquipment = serverUrl + '/equipment/deleteEquipment'; //删除设备                                                  
...
var issueBload = serverUrl + "/timeline//load";//发布精彩瞬间
...
var dletecomm = serverUrl+"/comment/delete";//删除评论
...
var favoritedelete = serverUrl + "/favorite/delete";//取消收藏  参数：type、typeId
...
var clazzPersonChildList = serverUrl+"/leave/clazzPersonTeacherList";// 参数：status 请假审批
...
var updateDayCheck =  serverUrl + "/dayCheck/updateDayCheck";
var getDayCheck = serverUrl + "/dayCheck/getDayCheck"; //修改晨检信息 id
var DayCheckgetaddClazzCheck = serverUrl + "/dayCheck/addClazzCheck";//全班合格 cid day
var DayCheckgetaddSchoolCheck = serverUrl + "/dayCheck/addSchoolCheck";//全园合格 day
var getClazzAllDayCheckByDay =serverUrl +"/dayCheck/getClazzAllDayCheckByDay";//全班合格 cid day

//预约指派
var getAssignedByTeacher = serverUrl + '/userRequest/getAssignedByTeacher';//获取指派列表 teacherId
var getAssignedDetail = serverUrl + '/userRequest/getAssignedDetail'; // 查看详情 urid
var addRecord = serverUrl + '/userRequest/insertRecord';//添加记录 id askRcordsJson



//isTest = true;
//recommendServerUrl = "http://192.168.1.25:50050";
var adminRegistUrl=serverUrl+"/backend/teacherRequest";//园长注册
var adminLoginUrl=serverUrl+"/backend/teacherLogin";//园长登录
var createAuthCodeOnLoginUrl=serverUrl+"/backend/createAuthCodeOnLogin";//根据手机号发送验证码
var updatePasswordAndLoginUrl=serverUrl+"/backend/updatePasswordAndLogin";//更改密码并且登录
var visitLogin = serverUrl + '/backend/customer';//游客参观
var getAllSchoolUrl=serverUrl+"/school/getAllSchool";//
var getAllDepartmentUrl=serverUrl+"/school/getAllDepartment";//
var getAllRolesUrl=serverUrl+"/school/getAllRoles";//

//课程
var teacherListUrl = serverUrl + "/backend/getAllTeachers";//获取教师id sid checkStatus
...
// var getNoticeList = serverUrl + "/notice/getClazzNotice";//获取全部通知列表
var getNoticeList = serverUrl + "/notice/getClazzAndSchoolNotice";//获取全部通知列表//long cid,long sid
...
var getNoticeDetailName = serverUrl + "/notice/getUserNoticeDetail";//获取通知详情家长名字列表
var remindNotice=serverUrl+"/notice/remindNoticeParents";//提醒公告通知 long nid, long uid, int userType
var signForNotice=serverUrl+"/notice/signUserNotice";//签收
//添加通讯录
...
//缴费相关的接口
var getClassChargePagerUrl=serverUrl+"/charge/getClassChargePager";//1.	学生缴费
var getClassChargeHistoryPagerUrl=serverUrl+"/charge/getClassChargeHistoryPager";//2.历史缴费
var searchClassChargeHistoryPagerUrl=serverUrl+"/charge/searchClassChargeHistoryPager";//3.缴费历史检索：
var loadClassChargeDetailUrl=serverUrl+"/charge/loadClassChargeDetail";//1.	缴费详情
var remindChargeParents =serverUrl+"/charge/remindChargeParents";

//教学资料
var getTeachAndDoc = serverUrl + "/path/getTeacherAllList";//获取园所教学资料与园所文档目录列表 pathType 1为园所文档 2为教学资料
...
var getMyFavorite = serverUrl + "/document/pager";//获取我的收藏 type=5 写死  type:1为课程 2为食谱 3为照片 4为文档
